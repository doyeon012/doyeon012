...
|  | 프로젝트 | 설명 | 기술 |
|:---:|:---|:---|:---|
| 🔌 | [**Circuit Simulator**](https://github.com/doyeon012/circuit-simulator#readme) | GUI 회로 시뮬레이터 — 졸업 프로젝트 및 논문 | `Python` `PyQt5` |
| 🐾 | [**Coonnection**](https://github.com/doyeon012/coonnection-api#readme) | 반려동물 입양 매칭 서비스 (API · Client) | `Node.js` `JavaScript` |
| 👥 | [**DevFriend API**](https://github.com/Introducing-developer-friends/DevFriend_api#readme) | 개발자 친구 매칭 API 서버 | `Node.js` `JavaScript` |
| 🚀 | [**MoEasy Backend**](https://github.com/doyeon012/MoEasy-backend#readme) | NestJS 기반 백엔드 서비스 | `NestJS` `TypeScript` |
...
<table>
  <tr>
    <td align="center" width="110"><b>Language</b></td>
    <td>
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=doyeon012&theme=tokyo-night&hide_border=true&bg_color=0D1117&color=6B9FE8&line=6B9FE8&point=FFFFFF&area=true&area_color=6B9FE8" width="95%" />
